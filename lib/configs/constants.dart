...
const String iconComputerAsset = "assets/images/Iconcomputer.svg";
const String iconTvAsset = "assets/images/Icontv.svg";
const String iconWifiAsset = "assets/images/ioswifi.svg";
const String iconChromeCastAsset = "assets/images/Iconchromecast.svg";
const String iconBluetoothAsset = "assets/images/Iconbluetooth.svg";
const String podcastsIconAsset = "assets/images/Icon-Podcasts.svg";
const String eventsIconAsset = "assets/images/Icon-Events.svg";
const String podcastWaveAsset = "assets/images/podcast_wave.svg";
...
const Color slateGray = Color.fromRGBO(123, 123, 139, 1);
const Color orange = Color.fromRGBO(234, 67, 53, 1);
const Color yellow = Color.fromRGBO(251, 188, 4, 1);
const Color purble = Color.fromRGBO(157, 0, 255, 1);
const Color green = Color.fromRGBO(52, 168, 83, 1);
const Color blue = Color.fromRGBO(0, 131, 253, 1);
const Color deepBinky = Color.fromRGBO(241, 23, 117, 1);
const Color btnBlue = Color.fromRGBO(57, 87, 154, 1);
